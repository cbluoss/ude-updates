...
Die Zentrale Scheinausgabe findet bis auf weiteres nicht statt. Wir bitten alle, die Leistungsnachweise für verschiedenen Anlässe, wie die Beantragung/Verlängerung von BAFÖG, Stipendien, Studienplatztausch etc. sich direkt an die Emailadresse: [med@uni-due.de](mailto:med@uni-due.de) zu wenden, um eine individuelle Scheinausgabe zu verabreden. Für den Fall, dass Sie eine Ersatzevaluationsbescheinigung benötigen, wenden Sie sich bitte an [eva.willmann@uk-essen.de](mailto:eva.willmann@uk-essen.de).
...
__Deutsche Forschungsgemeinschaft (DFG)__

Informationen werden laufend aktualisiert: [https://www.dfg.de/service/presse/berichte/2020/200318\_corona\_news/index.html](https://www.dfg.de/service/presse/berichte/2020/200318_corona_news/index.html)

*   DGF-Projekte allgemein ([PDF: 1\_Schreiben an alle Geförderten](/imperia/md/content/med/1_schreiben_an_alle_geförderten.pdf))
...
__Info__: &nbsp;&nbsp;&nbsp;&nbsp; Verwendungsnachweise können zu einem späteren Zeitpunkt eingereicht werden

__OP-EFRE (Leitmarkt.Agentur) __

__Info__:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Verlängerung der Einreichungsfristen (Sachberichte) können formell über ein rechtsverbindlich unterzeichnetes Schreiben/Fax beantragt werden. Bitte kontaktieren Sie dazu den ZBD. Weitere Informationen erhalten Sie direkt bei Ihrem zuständigen Ansprechpartner: <https://www.leitmarktagentur.nrw/kontaktpersonen>

__Stiftung Universitätsmedizin Essen:__
